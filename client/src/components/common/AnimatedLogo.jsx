  ...
  return (
    ...
    >
      <motion.svg
        ...
        variants={{ hover: { scale: 1.08, filter: 'drop-shadow(0px 0px 12px rgba(0,0,128,0.4))' } }}
      ...
      >
        ...
        <motion.path d="M 15 50 A 35 35 0 0 1 85 50 A 35 20 0 0 0 15 50 Z" fill="url(#saffronGrad)" />
        <motion.path d="M 85 50 A 35 35 0 0 1 15 50 A 35 20 0 0 0 85 50 Z" fill="url(#greenGrad)" />
        <motion.g
          variants={{
